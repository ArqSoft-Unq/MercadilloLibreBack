    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .and().authorizeRequests()
                ...
                .antMatchers(HttpMethod.PUT, "/v1/users/orders").hasAuthority(USER_AUTHORITY)
                .antMatchers(HttpMethod.GET, "/v1/users/orders").hasAuthority(USER_AUTHORITY)
                .antMatchers(HttpMethod.POST, "/v1/users/lineItems").hasAuthority(USER_AUTHORITY)
                .antMatchers(HttpMethod.PUT, "/v1/users/lineItems").hasAuthority(USER_AUTHORITY)
                .antMatchers(HttpMethod.DELETE, "/v1/users/lineItems").hasAuthority(USER_AUTHORITY)
