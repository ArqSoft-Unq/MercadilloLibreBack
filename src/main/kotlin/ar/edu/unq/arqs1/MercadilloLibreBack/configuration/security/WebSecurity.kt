...
import ar.edu.unq.arqs1.MercadilloLibreBack.security.BusinessDetailsService
...
class WebSecurity : WebSecurityConfigurerAdapter(true) {
    ...
    @Autowired
    lateinit var businessDetailsService: BusinessDetailsService

    @Autowired
    lateinit var jwtTokenFilter: JwtTokenFilter

    override fun configure(auth: AuthenticationManagerBuilder) {
        auth.userDetailsService(businessDetailsService)
    }
